...
const recentChats = [
<<<<<<< HEAD
  { id: 1, title: "How to train a neural network?", time: "2 mins ago", icon: "🤖" },
=======
  {
    id: 1,
...
<<<<<<< HEAD
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex">
      ...
      {/* Sidebar */}
      <div className="hidden lg:flex flex-col w-64 bg-black/60 backdrop-blur-md 
        ...
        <div className="mb-10 px-2">
          ...
          <p className="text-slate-500 text-xs mt-1">Intelligence at your fingertips</p>
=======
  const [message, setMessage] = useState("");
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex">
      <div
        className="fixed w-full top-0 left-0 z-50 flex justify-between px-4 py-3 rounded-sm border-b border-slate-600 bg-slate-700"
      >
        <div>
          <h1 className="text-2xl font-bold">
            <span className="text-blue-400">SOKKA</span>
      ...
      <div>
         {/* Sidebar */}
        <div 
        className="mt-12 h-[95vh] lg:flex flex-col w-[20vw] bg-blue/60 backdrop-blur-md 
                      border-r border-blue-500/20 px-4 py-6 fixed"
      >
        
        <div
          className="flex items-center gap-3 px-2 mb-7"
          onClick={() => navigate("/profile")}
          style={{ cursor: "pointer" }}
        >
          <div
            className="
                            flex items-center justify-center text-sm font-bold border-green-400 border-2 rounded-2xl"
          >
            <img
              src={avatarUrl}
              alt="avatar"
              className="w-5 h-7 style={{border-radius: 50%}}"
            />
          </div>
          <div>
...
=======
        ...
        <div className="mt-auto border-t border-slate-700 flex items-center justify-between">
          <button
            onClick={handleLogout}
            className="text-red-400 hover:text-red-300 mt-2 ml-4 bg-red-600/20 cursor-pointer hover:bg-red-600/30 px-3 py-2 rounded-lg text-sm transition-all duration-300"
          >
            Logout
          </button>
        </div>
        ...
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <p className="text-slate-400 text-lg mt-1">
              AI-Powered predictions for the next round of EPL action
            </p>
          </div>
          <div
            onClick={() => navigate("/profile")}
...
<<<<<<< HEAD
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {stats.map((stat) => (
            ...
            >
              ...
              <p className={`text-xs mt-1 ${colorMap[stat.color].split(" ").pop()}`}>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="bg-black/40 backdrop-blur-md border border-blue-500/20 rounded-xl p-6">
            <h3 className="text-lg font-semibold mb-4 text-blue-400">Recent Chats</h3>
          ...
          <div className="bg-black/40 backdrop-blur-md border border-purple-500/20 rounded-xl p-6 flex flex-col">
            <h3 className="text-lg font-semibold mb-4 text-purple-400">Quick Chat</h3>
...
=======
      ...
      <div className="fixed left-[20vw] w-[80vw] bottom-0 bg-slate-900 py-2 flex justify-between px-7 text-slate-400 text-sm">
          <div>
            <span className="font-bold text-green-500">SOKKA AI</span>
            <p className="font-light text-sm">Your intelligent AI assistant.</p>
          </div>
          <div>
            <p>Created by Jere, dev</p>
            <span>© 2026 Jeremiah. All rights reserved.</span>
          </div>
        </div>
    </div>
  );
